<?php
session_start();
require_once '../../config/connect.php'; // Đảm bảo kết nối
...
if (!isset($_SESSION['user_id'])) {
    echo "<script>alert('Bạn cần đăng nhập!'); window.location.href = '../Views/auth/login.php';</script>";
    exit();
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Gọi phương thức updateUser từ UserController
    $updateSuccess = $userController->updateUser($userId, $user_name, $email, $birth, $password, $image);
    ...
    <div id="profile_info">
        ...
        <div id="userProfile">
            ...
            <div class="form_inf">
                ...
                <div class="mb-3">
                    <p><strong>Birth:</strong> <?php echo isset($user['birth']) ? htmlspecialchars($user['birth']) : 'N/A'; ?></p>
                </div>
        ...
        <form id="editForm" action="" method="POST" enctype="multipart/form-data" style="display: none;">
            ...
            <div class="form_inf">
                ...
                <div class="mb-3">
                    ...
                    <input type="date" id="birth" name="birth" value="<?php echo isset($user['birth']) ? htmlspecialchars($user['birth']) : ''; ?>" class="form-control" required>
                </div>
                <div class="mb-3">
